    ...
    while True:
        ...
        if event == "Install WinRar":
            try:
                ...
                subprocess.run("powershell.exe Start-BitsTransfer -Source https://github.com/WagnerCoding/Admin-PS-Scripts/raw/main/PowerShellScripts/Scheduled%20Acct%20Deactivation.ps1 -Destination C:\\temp\\ScheduledAcctDeactivation.ps1", shell=True, capture_output=True, text=True),
                subprocess.Popen("powershell.exe c:\\temp\\ScheduledAcctDeactivation.ps1", shell=True, text=True),
